...
<script type="text/javascript">
	...
	function doSearch(){
		...
		$("#dg").datagrid("reload","../../toSearchTaskServlet.action?"+$("#conForm").serialize())
	}
	//查询任务详细信息
    function detail(id){    	           
	    openTopWindow({
	    	"url":"../../getTaskInfoServlet.action?id="+id,
	    	"title":"任务信息",
	    	"width" : 750,
	    	"height" : 600
		})
	...
	function edit(id){
		openTopWindow({
			"url":"../../toGetEditTaskServletaction?id="+id,
			"title":"修改任务信息",
			"width" : 850,
            "height" : 700
            })
...
$(function(){
	$("#dg").datagrid({
    	   title:"纳税人信息",
    	   toolbar:"#tb",
    	   url:"../../toSearchTaskServlet.action",
    	   coolapsible:true,
    	   method:"GET",
    	   loadMsg:"数据加载中..",
    	   pagination:true,
