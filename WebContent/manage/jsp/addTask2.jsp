					...
					<table class="kv-table" id="payerTable">
						<tbody>
							<tr>
								...
								<td id="p1" class="kv-content"></td>
								<td class="kv-label">生产经营地址</td>
								<td id="p2" class="kv-content"></td>
							</tr>
							<tr>
								<td class="kv-label">所属税务机关</td>
								<td id="p3" class="kv-content"></td>
								<td class="kv-label">行业</td>
								<td id="p4" class="kv-content"></td>
								<td class="kv-label">经营范围</td>
								<td id="p5" class="kv-content"></td>
							</tr>
							<tr>
								<td class="kv-label">票种核定</td>
								<td id="p6" class="kv-content"></td>
								<td class="kv-label">法人代表人</td>
								<td id="p7" class="kv-content"></td>
								<td class="kv-label">法人身份证号</td>
								<td id="p8" class="kv-content"></td>
							</tr>
							<tr>
								<td class="kv-label">主管财务</td>
								<td id="p9" class="kv-content"></td>
								<td class="kv-label">财务身份证号</td>
								<td id="p10" class="kv-content"></td>
							</tr>
							<tr>
								<td class="kv-label">录入日期</td>
								<td id="p11" class="kv-content"></td>
								<td class="kv-label">录入人员</td>
								<td id="p12" class="kv-content"></td>
							</tr>
						</tbody>
					</table>
					<div class="column">
