 ...
 */
@WebServlet("/ListTaxPayerServlet.action")
public class ListTaxPayerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Tax_PayerVODaoImpl tpvi = new Tax_PayerVODaoImpl();
		int count = tpvi.getAllTax_PayerVOByCount();
		List<Map<String, String>> list = tpvi.getAllTax_PayerVOs(Integer.parseInt(pageNo), Integer.parseInt(pageSize),payerCode,payerName);
